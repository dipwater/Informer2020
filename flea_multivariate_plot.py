...
PREFIX = 'Spall'
# 模型路径
MODEL_PATH = f'./checkpoints/informer_FLEA_ftMS_sl500_ll50_pl50_dm512_nh8_el2_dl1_df2048_atprob_fc5_ebfixed_dtTrue_mxTrue_Exp_fixed_2/checkpoint.pth'
# 数据路径
DATA_PATH = f'./data/FLEA/{PREFIX}.csv'
# 输出图像保存路径
OUTPUT_PLOT = f'./plots/prediction_flea_{PREFIX}_multivariate.png'
# 图像标题
TITLE = f'Full {PREFIX} Multivariate Prediction Result'
SKIP_LINES = 0
if PREFIX == 'Jam':
    SKIP_LINES = 9119
